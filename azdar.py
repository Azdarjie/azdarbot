...
admin = ["u022a15300c6f88068ec0aa0f39d8bf33","",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid]
owner = ["u022a15300c6f88068ec0aa0f39d8bf33",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid]
wait = {
    'contact':False,
    'autoJoin':False,
...
#========================================
            elif msg.text in ["Azdar in","Myazdar"]:
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = "u022a15300c6f88068ec0aa0f39d8bf33"
			if op.param2 in OWN:
				pass
			else:
				Inviter = op.param3.replace("",',')
