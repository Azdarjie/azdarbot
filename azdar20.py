...
cl = LINETCR.LINE()
cl.login(token="ErjRcujQrxb6hGi7xbW1.FQ+YZEcvIrJ/SRynwFHxuq.Y5W/iNIWdSl5R7mCjvKapeF4Yd6In5p13Ja8UvdtxPs=")
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
ki.login(token="ErLoV2fvBLFzT4JsQO01.+9D8bBS2agEqwy0loTTS4q.80VKx4/9A83gr4Vre0d+O7ILSSnnq9e+IvcKwKkDIjc=")
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token="Er9u11X5c6mjARoDDeld.w338/CzRAIeD2zSL5dgH3q.CacxDOzH8la7HQ7w6HemcLHqBvaC1dNK17I+1Idjrhc=")
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
kc.login(token="ErWcTapuA7bNhoZux939.RTjb61uZuO34ZTcyOFc9Aq.j7gkm+bFrDiKVye1q9IVIGHmLdqh4hzrQ/rvxbOnN6A=")
kc.loginResult()
print "Kc-Login Success\n"

kd = LINETCR.LINE()
kd.login(token="Erue83LkzDWr6aIfSCua.1UreLE2U683GLhm+qxotYG.UKAbjND20duM5RWwIsH0zY65t6w+1ZP0+AukcgiVsKc=")
kd.loginResult()
print "Kd-Login Success\n"

ke = LINETCR.LINE()
ke.login(token="Er0ZT2g5CYWF9zxETsuf.vLifoh7rNcgdydgyIKUkhW.8ixcuI6j3WeN9DmxXSPe62pGFWVqoYjonpwVusiZzuU=")
ke.loginResult()
print "Ke-Login Success\n"

kf = LINETCR.LINE()
kf.login(token="ErTZw7A3K5c5HXAtbln6.TbrO5isHgk7I8EzvJH4oLG.A6JFyI2sRv4l6ZGpKqzoa4F5PG7oNQT+zqH3+ouh2Mw=")
kf.loginResult()
print "Kf-Login Success\n"

kg = LINETCR.LINE()
kg.login(token="ErFhNPX51wxKE3kqOzLb.l7NIYaIaTod74Jm/zfpxYW.2E1oSU4cjBoQBDyGKzKn8LIidI9eumj20KRBj6tff7Q=")
kg.loginResult()
print "Kg-Login Success\n"

kh = LINETCR.LINE()
kh.login(token="ErFzgxmF2NuFcuA6l3I6.xxH0gQ1IWQWesZZH2vrLbG.yq6eiPBAk1iadBhzHrJ4E39DDiwTZUeGhSDuR2iRkTk=")
kh.loginResult()
print "Kh-Login Success\n"

kj = LINETCR.LINE()
kj.login(token="Er6UhGq3NtIalwT13zof.ZwlP1iST01Yu/iHVMuCo3W.LvMWYeyfUqf9jhcFwQ5hN1seMlwqjom35GjLJxmxsYw=")
kj.loginResult()
print "Kj-Login Success\n"

kl = LINETCR.LINE()
kl.login(token="Er1TsfeaH91RHsctosI7.c4vJ5tbUOgnfq16KlpT+LW.SDibwRGF/5aUnXs8ESfCUDmfxO4KKLB1I7xZMCBsFfM=")
kl.loginResult()
print "Kl-Login Success\n"

km = LINETCR.LINE()
km.login(token="ErMgSsuVDGoPHEdwQeFc.uuoM3KjEFgPZMhVvSvTtla.VfXrsy2/zaozxC/ItdL52dvwKZ7UqeoKfAP4MZ/DV/k=")
km.loginResult()
print "Km-Login Success\n"

kn = LINETCR.LINE()
kn.login(token="ErxkxO914PqP5fKlyvA4.4OpJRE9QuXI2BIlYB20v9a.bOD67n8CF7yKCazp6CdUcC7+RrcM/dQ6uDXn9gUil0Q=")
kn.loginResult()
print "Kn-Login Success\n"

ko = LINETCR.LINE()
ko.login(token="Er40DLp5Yt3FJan2b454.tHeYsqCsKuwDVXPLgbx0Xa.D0p9TUtnTJLAF8bY8Jbo6A8PQS2tpPMB2pIJAKHCtqA=")
ko.loginResult()
print "Ko-Login Success\n"

kp = LINETCR.LINE()
kp.login(token="ErHmnq2gEUQA04Q6TTlf.Ha0IwyYmxbkiTqi5ZOU+FW.9AFz7GIK6PsLldrI8crbn6p963yNjqFN4+MV+aVSrZ8=")
kp.loginResult()
print "Kp-Login Success\n"

kq = LINETCR.LINE()
kq.login(token="Er0PwDUKqogCuGbJERnd.u6obRJMeBFGxdLOaL86V+q.O1GS+0NGCx1tMKvqkkNdTwHhY/tm+wBkjAwvfNz0dXU=")
kq.loginResult()
print "Kq-Login Success\n"

kr = LINETCR.LINE()
kr.login(token="ErajHrFBW9lCZseULLKc.CUgqYVVHd9PSVYF6mPAu7a.Knbv5Yu1hsiaXP72iIq62ZLj+2jtNEGjMVhwJmrfujk=")
kr.loginResult()
print "Kr-Login Success\n"

ks = LINETCR.LINE()
ks.login(token="EreG268J8pOOCZi1cY39.L1xwMg9Ga86LdYu+VeFxsq.6PkTYdA8W4IYgKwba7sLme9Iv37PtUVwvSg6hvKtMYw=")
ks.loginResult()
print "Ks-Login Success\n"

kt = LINETCR.LINE()
kt.login(token="ErNufwLVw1MZzVxgBYw3.rgO8KJQxdDII01dXUEhsqW.gaa7bZh3rM295e+WCAySWaLwMqvyzXSY20p+K+QzmTU=")
kt.loginResult()
print "Kt-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='ErFMpwkrHi4NbMn9F4x3.aIOvmaXVIaAoWkOpoDI+mW.rMpMfaBd8yxVmC+ihQhf4bXmvrA42v5ALDwRS0oXsMU=')
vipro.loginResult()
print "Vipro-Login Success\n"

kz = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#kz.login(qr=True)
kz.login(token='EqGcWZhx3ERynkNKqr55.GR8F+A21sjEa1VzygXw1Tq.F+B6E7EjEqbT92lu8ggC68rw11sWktiu/kfWbyWuUww=')
kz.loginResult()
...
╚══════════════════════
"""
tjia="u022a15300c6f88068ec0aa0f39d8bf33"
...
KAC=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq,kr,ks,kt,vipro]
...
Xmid = vipro.getProfile().mid
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Zmid,Xmid]
Creator = ["u022a15300c6f88068ec0aa0f39d8bf33"]
admin = [Xmid,mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Zmid]
...
backup11 = kl.getProfile()
backup11.displayName = contact.displayName
backup11.statusMessage = contact.statusMessage
backup11.pictureStatus = contact.pictureStatus

contact = km.getProfile()
backup12 = km.getProfile()
backup12.displayName = contact.displayName
backup12.statusMessage = contact.statusMessage
backup12.pictureStatus = contact.pictureStatus

contact = kn.getProfile()
backup13 = kn.getProfile()
backup13.displayName = contact.displayName
backup13.statusMessage = contact.statusMessage
backup13.pictureStatus = contact.pictureStatus

contact = ko.getProfile()
backup14 = ko.getProfile()
backup14.displayName = contact.displayName
backup14.statusMessage = contact.statusMessage
backup14.pictureStatus = contact.pictureStatus

contact = kp.getProfile()
backup15 = kp.getProfile()
backup15.displayName = contact.displayName
backup15.statusMessage = contact.statusMessage
backup15.pictureStatus = contact.pictureStatus

contact = kq.getProfile()
backup16 = kq.getProfile()
backup16.displayName = contact.displayName
backup16.statusMessage = contact.statusMessage
backup16.pictureStatus = contact.pictureStatus

contact = kr.getProfile()
backup17 = kr.getProfile()
backup17.displayName = contact.displayName
backup17.statusMessage = contact.statusMessage
backup17.pictureStatus = contact.pictureStatus

contact = ks.getProfile()
backup18 = ks.getProfile()
backup18.displayName = contact.displayName
backup18.statusMessage = contact.statusMessage
backup18.pictureStatus = contact.pictureStatus

contact = kt.getProfile()
backup19 = kt.getProfile()
backup19.displayName = contact.displayName
backup19.statusMessage = contact.statusMessage
backup19.pictureStatus = contact.pictureStatus
...
responsename16 = kq.getProfile().displayName
responsename17 = kr.getProfile().displayName
responsename18 = ks.getProfile().displayName
responsename19 = kt.getProfile().displayName
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment2":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment3":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment4":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment5":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment6":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment7":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment8":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment9":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment10":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment11":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment12":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment13":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment14":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment15":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment16":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment17":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment18":"Auto Like ©By : ⏩Azdar Team Bot⏪",
    "comment19":"Auto Like ©By : ⏩Azdar Team Bot⏪",    
    "commentOn":True,
    "commentBlack":{},
    "message":"Makasih sudah add salken ya kk (^_^)",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":{},
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    ...
                                    if len(nick) == 2:
                                        ...
                                        cl.sendText(op.param1, "Nah ada  " + nick[0] )
                                else:
                                    cl.sendText(op.param1, "Sini  " + Name + "  Gosip yuk")
                        else:
                            pass
                    else:
                        pass
...
#----------------------
        ...
        if op.type == 13:
                ...
                if mid in op.param3:	        
			        ...
			        G.preventJoinByTicket = True
			        cl.updateGroup(G)
			        cl.sendText(op.param1,"⏩Azdar Team Protect⏪\n\nNumpang nginap ya kak (^_^)")
                ...
                if mid in op.param3:
			        ...
			        G.preventJoinByTicket = True
			        cl.updateGroup(G)
			        cl.sendText(op.param1,"☆Room diambil alih☆\n☆⏩Azdar Team Bot⏪ ^_^ ☆")
                else:
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                if wait['likeOn'] == True:
                     ...
                     kf.like(url[25:58], url[66:], likeType=1002)
                     kg.like(url[25:58], url[66:], likeType=1004)
                     kh.like(url[25:58], url[66:], likeType=1003)
                     kj.like(url[25:58], url[66:], likeType=1001)
                     kl.like(url[25:58], url[66:], likeType=1005)
                     km.like(url[25:58], url[66:], likeType=1002)
                     kn.like(url[25:58], url[66:], likeType=1004)
                     ko.like(url[25:58], url[66:], likeType=1003)
                     kp.like(url[25:58], url[66:], likeType=1001)
                     kq.like(url[25:58], url[66:], likeType=1005)
                     kr.like(url[25:58], url[66:], likeType=1002)
                     ks.like(url[25:58], url[66:], likeType=1004)
                     kt.like(url[25:58], url[66:], likeType=1003)
                     ...
                     kd.comment(url[25:58], url[66:], wait["comment5"])
        ...
        if op.type == 26:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Si Raja Tikung.. (-_-)")
		
            elif msg.text in ["Admin","admin"]:
                msg.contentType = 13
                admin1 = "u022a15300c6f88068ec0aa0f39d8bf33"
                admin2 = "u022a15300c6f88068ec0aa0f39d8bf33"
                admin3 = "u022a15300c6f88068ec0aa0f39d8bf33"
                msg.contentMetadata = {'mid': tjia}
		...
		random.choice(KAC).sendText(msg.to,"Itu Admin Kami (^_^)")	
              ...
              if admin == []:
                  ...
                  cl.sendText(msg.to,"Wait Bossku...")
                  mc = "╔════════════════════\n║☆☞  ⏩Azdar Team Bot⏪  ☜☆\n╠════════════════════\n"
                  for mi_d in admin:
		...
		gCreator = ginfo.creator.mid
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Yang Punya Rumah")
            ...
            if msg.contentType == 13:
                if wait['invite'] == True:
                     ...
                     groups = kg.getGroup(msg.to)                     
                     groups = kh.getGroup(msg.to)                     
                     groups = kj.getGroup(msg.to)                     
                     groups = kl.getGroup(msg.to)
                     groups = km.getGroup(msg.to)                     
                     groups = kn.getGroup(msg.to)                     
                     groups = ko.getGroup(msg.to)                     
                     groups = kp.getGroup(msg.to)                     
                     groups = kq.getGroup(msg.to)
                     ...
                     if targets == []:
                         ...
                         for target in targets:
                             try:
                                 ...
                                 kq.findAndAddContactsByMid(target)
              ...
              if msg.from_ in admin:
		        ...
		        cl.sendText(msg.to, "Suruh yg lain ajah kak \nLagi mojok soalnya..")
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus ⏩Azdar Team Bot⏪")
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = cl.getGroup(i).name
		        if h == ng:
			    cl.sendText(i,"Pamit yah, dipanggil ⏩Azdar⏪")
		            cl.leaveGroup(i)
			    ki.leaveGroup(i)
			    kk.leaveGroup(i)
			    kc.leaveGroup(i)
		...
		gid = cl.getGroupIdsJoined()
            ...
            elif msg.text in ["Cancel all","Cancelall"]:
                if msg.toType == 2:
		...
		print wait["AutoKick"]
	     ...
	     if msg.from_ in admin:	        
                wait["Ghost"] = True
                cl.sendText(msg.to,"Mantan Sudah Aktif")
	     else:
		    cl.sendText(msg.to,"⏩Azdar⏪")		
	     ...
	     if msg.from_ in admin:	        
                wait["Ghost"] = False
                cl.sendText(msg.to,"Mantan Sudah Di Nonaktifkan")
	     else:
		    cl.sendText(msg.to,"⏩Azdar⏪")	     
		...
		if msg.from_ in admin:
                    ...
                    wait["Qron"] = True
                    wait["Ghost"] = True     
                    cl.sendText(msg.to,"All Protect Sudah Aktif")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
		else:
		...
		if msg.from_ in admin:
                    ...
                    wait["Qron"] = False
                    wait["Ghost"] = False 
                    cl.sendText(msg.to,"All Protect Sudah Di Nonaktifkan")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
#		else:                    
		    ...
		    cl.sendText(msg.to,"⏩Azdar⏪")
              ...
              if msg.from_ in admin:
                try:
		            ...
		            cl.sendText(msg.to,"Males ahh kak, cek ajah sendiri (-_-)")
            ...
            elif msg.text in ["Status","Set","Setting","Sett"]:
              if msg.from_ in admin:
                md = ""
		if wait["Sambutan"] == True: md+="╠➩ Notif : 📱\n"
		else:md+="╠➩ Sambutan : 📴\n"
		if wait["joinkick"] == True: md+="╠➩ Join Kick : 📱\n"
		else:md+="╠➩ Join Kick : 📴\n"		
		if wait["AutoJoin"] == True: md+="╠➩ Auto Join : 📱\n"
                else: md +="╠➩ Auto Join : 📴\n"
		if wait["AutoJoinCancel"] == True: md+="╠➩ Auto Join Cancel : 📱\n"
                else: md +="╠➩ Auto Join Cancel : 📴\n"                
		if wait["Leave"] == True: md+="╠➩ Leave : 📱\n"
                else: md +="╠➩ Leave : 📴\n"                
		if wait["Contact"] == True: md+="╠➩ Info Contact : 📱\n"
		else: md+="╠➩ Info Contact : 📴\n"
                if wait["AutoCancelon"] == True:md+="╠➩ Auto Cancel : 📱\n"
                else: md+= "╠➩ Auto Cancel : 📴\n"
                if wait["inviteprotect"] == True:md+="╠➩ Invite Protect : 📱\n"
                else: md+= "╠➩ Invite Protect : 📴\n"                
		if wait["Qron"] == True: md+="╠➩ Qr Protect : 📱\n"
		else:md+="╠➩ Qr Protect : 📴\n"
		if wait["AutoKickon"] == True: md+="╠➩ Auto Kick : 📱\n"
		else:md+="╠➩ Auto Kick : 📴\n"
		if wait["Ghost"] == True: md+="╠➩ Ghost : 📱\n"
		else:md+="╠➩ Ghost : 📴\n"
		if wait["alwaysRead"] == True: md+="╠➩ Always Read : 📱\n"
		else:md+="╠➩ Always Read: 📴\n"
		if wait["detectMention"] == True: md+="╠➩ Auto Respon : 📱\n"
		else:md+="╠➩ Auto Respon : 📴\n"		
		if wait["kickMention"] == True: md+="╠➩ Auto Respon Kick : 📱\n"
		else:md+="╠➩ Auto Respon Kick : 📴\n"				
		if wait["Sider"] == True: md+="╠➩ Auto Sider : 📱\n"
		else:md+="╠➩ Auto Sider: 📴\n"	
		if wait["Simi"] == True: md+="╠➩ Simisimi : 📱\n"
		else:md+="╠➩ Simisimi: 📴\n"		
                cl.sendText(msg.to,"╔══════════════════════\n""║           ☆☞ S T A T U S ☜☆\n""╠══════════════════════\n"+md+"╚══════════════════════")
            ...
            elif msg.text.lower() in ["deh","hadeh","haddeh"]:
                msg.contentType = 7
            ...
            elif msg.text.lower() in ["deh","addeh","adeh","duh","aduh","aduuh","haddeh","hadeh"]:
                msg.contentType = 7
            ...
            elif msg.text.lower() in ["nyanyi","smule"]:
                msg.contentType = 7
                ...
                if msg.from_ in admin:
                  ...
                  try:
		              ...
		              cl.sendText(msg.to, "Tag ajah ndiri..  (-_-)")
		...
		kicker = [ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq,kr,ks,kt]
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                kp.findAndAddContactsByMid(midd)
                kq.findAndAddContactsByMid(midd)
                ...
                midd = "u022a15300c6f88068ec0aa0f39d8bf33"
                cl.inviteIntoGroup(msg.to,[midd])

            elif msg.text in ["Welcome","welcome","Welkam","welkam","Wc","wc"]:
                gs = cl.getGroup(msg.to)
                cl.sendText(msg.to,"Selamat Datang Kak Di "+ gs.name)
                msg.contentType = 7
		...
		if msg.from_ in Creator:
		    for i in gid:
			cl.sendText(i,"=======[BROADCAST]=======\n\n"+bc+"\n\nContact Me : http://line.me/ti/p/~azdar86")
		    cl.sendText(msg.to,"Success BC BosQ")
		else:
		    cl.sendText(msg.to,"Khusus ⏩Azdar⏪")
            ...
            elif msg.text in ["Azdar","Azdar in","Helep"]:
		if msg.from_ in admin:
		...
		if msg.from_ in admin:
            ...
            elif msg.text in ["Ghost in","Mantan in"]:
		if msg.from_ in admin:
                    G = cl.getGroup(msg.to)
                    ginfo = cl.getGroup(msg.to)
                    G.preventJoinByTicket = False
		...
		try:
		    ...
		    print E
              ...
              if msg.from_ in Creator:		    
		          ...
		          cl.sendText(msg.to,"Bilang Dulu Sama ⏩Azdar⏪")                    
            ...
            elif msg.text in ["Mybots","bot","Absen","absen"]:
		cl.sendText(msg.to,"⏩ Azdar Team Protect ⏪")
                ki.sendText(msg.to,"Queen ON  👧")
                kk.sendText(msg.to,"Team 1 Hadiir 👮")
                ke.sendText(msg.to,"No.4 Hadir")
                kf.sendText(msg.to,"No.5 Hadir")
                kg.sendText(msg.to,"No.6 Hadir")
                kh.sendText(msg.to,"No.7 Hadir")
                kc.sendText(msg.to,"Team 2 Hadiir 👿")
                kj.sendText(msg.to,"No.8 Hadir Boss")
                kl.sendText(msg.to,"No.9 Hadir Boss")
                km.sendText(msg.to,"No.10 Hadir Boss")
                kn.sendText(msg.to,"No.11 Hadir Boss")
                kd.sendText(msg.to,"Team 3 Hadir 👷")
                ko.sendText(msg.to,"No.12 Hadir Boss")
                kp.sendText(msg.to,"No.13 Hadir Boss")
                kq.sendText(msg.to,"No.14 Hadir Boss")
                kr.sendText(msg.to,"No.15 Hadir Boss")
                ks.sendText(msg.to,"Bagian Nikung Juga Hadir Boss 😅")
                kt.sendText(msg.to,"Semua Ready Boss..!!")
                ...
                kd.sendText(msg.to,responsename5)
                ke.sendText(msg.to,responsename6)
                kf.sendText(msg.to,responsename7)
                kg.sendText(msg.to,responsename8)
                kh.sendText(msg.to,responsename9)
                kj.sendText(msg.to,responsename10)
                kl.sendText(msg.to,responsename11)
                km.sendText(msg.to,responsename12)
                kn.sendText(msg.to,responsename13)
                ko.sendText(msg.to,responsename14)
                kp.sendText(msg.to,responsename15)
                kq.sendText(msg.to,responsename16)
                kr.sendText(msg.to,responsename17)
                ks.sendText(msg.to,responsename18)
                kt.sendText(msg.to,responsename19)

            elif msg.text in ["Sp","Naikin","Percepat"]:
                start = time.time()
                print("Speed")                
                elapsed_time = time.time() - start
		cl.sendText(msg.to, "Ok sabar boss...")
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))
            elif "Tambah lagi" in msg.text:
                cl.sendText(msg.to, "Capek Boss (-_-)")
                start = time.time()
                ...
                start = time.time()
                cl.sendText(msg.to, "Now Loading...")
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))                
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Lu sape!")
              ...
              if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    cl.sendText(msg.to,"Bersih Boss")
                else:
                    mc = ""
            ...
            elif msg.text.lower() in ["assalamu alaikum","assalamualaikum","assalamu'alaikum"]:
                cl.sendText(msg.to,"wa'alaikum salam") 
                cl.sendText(msg.to,"☆ Salken ya kak ☆") 
		...
		if msg.from_ in admin:
		    ...
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        ...
                        _name = msg.text.replace("afk","")
                        gs = ki.getGroup(msg.to)
                        gs = kk.getGroup(msg.to)
                        gs = kc.getGroup(msg.to)
                        ki.sendText(msg.to,"Salken kak")
                        targets = []
                        for g in gs.members:
		...
		if msg.from_ in Creator:
            ...
            elif "Azdar1 copy @" in msg.text:
              if msg.from_ in Creator:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Azdar1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "Azdar2 copy @" in msg.text:
              if msg.from_ in Creator:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Azdar2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "Azdar3 copy @" in msg.text:
              if msg.from_ in Creator:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Azdar3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "Azdar4 copy @" in msg.text:
              if msg.from_ in Creator:
                   print "[COPY] Ok"
                   _name = msg.text.replace("Azdar4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                ...
                try:
                    ...
                    kd.updateProfile(backup5)
                    
                    ke.updateDisplayPicture(backup6.pictureStatus)
                    ke.updateProfile(backup6)

                    kf.updateDisplayPicture(backup7.pictureStatus)
                    kf.updateProfile(backup7)

                    kg.updateDisplayPicture(backup8.pictureStatus)
                    kg.updateProfile(backup8)

                    kh.updateDisplayPicture(backup9.pictureStatus)
                    kh.updateProfile(backup9)
                    
                    kj.updateDisplayPicture(backup10.pictureStatus)
                    kj.updateProfile(backup10)
                    
                    kl.updateDisplayPicture(backup11.pictureStatus)
                    kl.updateProfile(backup11)

                    km.updateDisplayPicture(backup12.pictureStatus)
                    km.updateProfile(backup12)

                    kn.updateDisplayPicture(backup13.pictureStatus)
                    kn.updateProfile(backup13)

                    ko.updateDisplayPicture(backup14.pictureStatus)
                    ko.updateProfile(backup14)
                    
                    kp.updateDisplayPicture(backup15.pictureStatus)
                    kp.updateProfile(backup15)
                    
                    kq.updateDisplayPicture(backup16.pictureStatus)
                    kq.updateProfile(backup16)

                    kr.updateDisplayPicture(backup17.pictureStatus)
                    kr.updateProfile(backup17)

                    ks.updateDisplayPicture(backup18.pictureStatus)
                    ks.updateProfile(backup18)
                    
                    kt.updateDisplayPicture(backup19.pictureStatus)
                    kt.updateProfile(backup19)
            ...
            elif msg.text.lower() in ["hi","hay","hai","hallo"]:
            ...
            elif "/Azdar" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/Azdar","Azdar")
            ...
            elif "/Azdar1" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/Azdar1","Azdar1")
                    if len(string.decode('utf-8')) <= 5000:
		...
		if msg.from_ in Creator:
                    string = msg.text.replace("/Azdar2","Azdar2")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/Azdar3" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/Azdar3","Azdar3")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/Azdar4" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/Azdar4","Azdar4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
              ...
              if msg.from_ in admin:
                ...
                kd.sendText(msg.to,"Siyap")
                cl.sendText(msg.to,"Okeh")
                ki.sendText(msg.to,"Katanya owner kita Jomblo ya")
                kk.sendText(msg.to,"Iya emang")
                kc.sendText(msg.to,"Denger denger si lagi nyari pacar dia")
                kd.sendText(msg.to,"Udah ah... \ngosip mulu doain aja biar dapet")
            ...
            elif msg.text in ["Kalender","Hari","Waktu"]:
