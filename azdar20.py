...
cl = LINETCR.LINE()
cl.login(token="EqrYkSDealXhak7AEec1.FQ+YZEcvIrJ/SRynwFHxuq.Mnamki/gav965e6cHmA15krfK/PidbnDDNC7UfqFpMY=")
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
ki.login(token="Eqw4VpKy6AMqts6Ag1Z1.+9D8bBS2agEqwy0loTTS4q.dEfj6iipr/3lLc00/mZNE3Q9izl+KJ0acEj4CQFtH7w=")
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
kk.login(token="EqPPzhhXe16FLRQNKMyd.w338/CzRAIeD2zSL5dgH3q.cX4v8Y5mAG9Vm2Tn2fwMqU/6cahtfXGc/KbBD1mYGIg=")
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
kc.login(token="EqkwjNWHN3H3tiN1tEB9.RTjb61uZuO34ZTcyOFc9Aq.5xOpueka2IHFw+3ub+fwD96YvLurq4UE50ceZcE+E3I=")
kc.loginResult()
print "Kc-Login Success\n"

kd = LINETCR.LINE()
kd.login(token="EqF2QTmjH5q3GwwSiRaa.1UreLE2U683GLhm+qxotYG.LO5CnDVuXwClWt35GCOsm4eR+jW8S35L2vnjpLyGu+0=")
kd.loginResult()
print "Kd-Login Success\n"

ke = LINETCR.LINE()
ke.login(token="Erui2CB1mlRk4vSj7n3f.vLifoh7rNcgdydgyIKUkhW./6bMeOV6b87KIzxYAFSI7DajiOao/mMgfi5kemBFe+8=")
ke.loginResult()
print "Ke-Login Success\n"

kf = LINETCR.LINE()
kf.login(token="ErlwjYJVoN3yLF14BcD6.TbrO5isHgk7I8EzvJH4oLG.TBsw9nekJjC3VxjzRJQHHwsS82Bu48RuPMjkDKb+0NA=")
kf.loginResult()
print "Kf-Login Success\n"

kg = LINETCR.LINE()
kg.login(token="ErJ4cRIfUhDFjoTMgopb.l7NIYaIaTod74Jm/zfpxYW.CgZK321xeowf9e17139s7RgRceIfRyz0srpFuL80FcI=")
kg.loginResult()
print "Kg-Login Success\n"

kh = LINETCR.LINE()
kh.login(token="EraBJoI0eqlYs0xMoS46.xxH0gQ1IWQWesZZH2vrLbG.G5CD1gI0z2i5B1QrEv9ySA/gLp6wuVt1JEJAz0ZWYuY=")
kh.loginResult()
print "Kh-Login Success\n"

kj = LINETCR.LINE()
kj.login(token="ErXDSTuFyTpWqjiADTQf.ZwlP1iST01Yu/iHVMuCo3W.Nk7uZxNMhdkDjA4tE0TceyS+EGL6sx5+ppLjqM4AMZs=")
kj.loginResult()
print "Kj-Login Success\n"

kl = LINETCR.LINE()
kl.login(token="ErXDCkqHQyio8FnPnYP7.c4vJ5tbUOgnfq16KlpT+LW.94sWgMd+9xsF15xED4Wp5NHuUEefacohP/uuwB8mOm0=")
kl.loginResult()
print "Kl-Login Success\n"

km = LINETCR.LINE()
km.login(token="ErtpyyvtSECyWG9e99Wc.uuoM3KjEFgPZMhVvSvTtla.oSS7wjPEBhr1OsqRG+28pRTwhIP5qRYU7ms4Z3gOFGM=")
km.loginResult()
print "Km-Login Success\n"

kn = LINETCR.LINE()
kn.login(token="EroOzBmUZzusqUKfLQb4.4OpJRE9QuXI2BIlYB20v9a.rxlIGtQ8/3VKkgf0qzeJ8AFrOGOVBIE+al18R1aPJUo=")
kn.loginResult()
print "Kn-Login Success\n"

ko = LINETCR.LINE()
ko.login(token="ErJ1OfifbeTNizZzvDH4.tHeYsqCsKuwDVXPLgbx0Xa.yRekUEsQxbpP0eNpB+HRQiz2glleX7OeXzyr63yFTlI=")
ko.loginResult()
print "Ko-Login Success\n"

kp = LINETCR.LINE()
kp.login(token="ErBta3bUBeCZVpxfeDKf.Ha0IwyYmxbkiTqi5ZOU+FW.0gwgQIyzMQt+4/zWvpLIhJ0uNKHnDEB8KQWqy/aCa1w=")
kp.loginResult()
print "Kp-Login Success\n"

kq = LINETCR.LINE()
kq.login(token="ErXhplVwEUncepRL6uGd.u6obRJMeBFGxdLOaL86V+q.gPhxMTPuzQ1EV5NoqL6X8wVWO+NKGXoV6Pwb564eQ+c=")
kq.loginResult()
print "Kq-Login Success\n"

kr = LINETCR.LINE()
kr.login(token="ErFfjqvF48vbcNV76pTc.CUgqYVVHd9PSVYF6mPAu7a.LTn2eRrgVJ8nDWz2934bIstCpzQWHCEsoxvzWPCY310=")
kr.loginResult()
print "Kr-Login Success\n"

ks = LINETCR.LINE()
ks.login(token="ErA8vqF1QaiZGR6ZT3K9.L1xwMg9Ga86LdYu+VeFxsq.GTIUaTBcOb6uTdiNy+cKR4aWxGseWFwbtgeSqLZYdEg=")
ks.loginResult()
print "Ks-Login Success\n"

kt = LINETCR.LINE()
kt.login(token="ErPOIO85aXRxVJJRrbL3.rgO8KJQxdDII01dXUEhsqW.vU6mSesfKErSAr5NeXU7CAhiE4DRn0owD4D1HJ/GpTw=")
kt.loginResult()

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='ErZcolierNqtiVT2ClV3.aIOvmaXVIaAoWkOpoDI+mW.VpBZm87Y8AxVaGIm01zzzzXaxrmw1jwoizSWgU0YiBM=')
vipro.loginResult()
...
def bot(op):
    try:
        ...
        if op.type == 19:
          ...
          try:
            if op.param3 in Xmid: #Akun Utama Ke Kick
...
#		else:                    
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Lu sape!")
              ...
              if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    random.choice(KAC).sendText(msg.to,"Bersih Boss")
                else:
                    mc = ""
		...
		if msg.from_ in admin:
		    ...
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        ...
                        _name = msg.text.replace("zz","")
                        gs = ki.getGroup(msg.to)
                        gs = kk.getGroup(msg.to)
                        gs = kc.getGroup(msg.to)
                        ki.sendText(msg.to,"Loading Target ...!!")
                        kd.sendText(msg.to,"Bye ~")
                        targets = []
                        for g in gs.members:
