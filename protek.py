...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EqGcWZhx3ERynkNKqr55.GR8F+A21sjEa1VzygXw1Tq.F+B6E7EjEqbT92lu8ggC68rw11sWktiu/kfWbyWuUww=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EqerulDJjuRVrCuhBA01.+9D8bBS2agEqwy0loTTS4q.fSwoy1fvLi30TrwFzRBr44Ryy2PtSIlXpSVFkhjzrdU=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Eq6vzyde59KBPHAbpicd.w338/CzRAIeD2zSL5dgH3q.rrzGnziMBKYP1QCVw16YCu3WaZQe+5NsooDZ6d8BcBQ=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EqiA608cM1aSui7b3Zi9.RTjb61uZuO34ZTcyOFc9Aq.KGQ5ezcA7eWHOEmWdP5WKYorGl8CcQojt3FePCTEOMs=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EqK8vSJCyDotrpVSJDRa.1UreLE2U683GLhm+qxotYG.cHOxmD2sDeEVrgebkE363ylv/cwOBJDSNZM2PeLSApQ=')
kr.loginResult()
print "Kr-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='EqVd9fz6ErRsE0fEWwc3.aIOvmaXVIaAoWkOpoDI+mW.5Ad9aStuL5Nq+nkLSc/uWrV6SublLykijK7QJRCCQ/s=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='EqNyKn1QSRmO9lAU6NZ8.VTlFS4ocHUKegiMPHt1wka.Yvz66C1/woV4i9uxcMxhkMfDCJBHNDhdjbBBRNm5dks=')
km.loginResult()
...
╚══════════════════════
"""
tjia="u022a15300c6f88068ec0aa0f39d8bf33","u5b7dfcf9c66b6a211dd99b25e431a1dd"
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"uffd77c05bb36006790598d0b3adb6ce1","u5b7dfcf9c66b6a211dd99b25e431a1dd"]
Creator=["u022a15300c6f88068ec0aa0f39d8bf33","u5b7dfcf9c66b6a211dd99b25e431a1dd"]
admin=["u022a15300c6f88068ec0aa0f39d8bf33","u5b7dfcf9c66b6a211dd99b25e431a1dd"]
...
wait = {
    ...
    "commentOn":True,
    "commentBlack":{},
    "message":"Makasih sudah add saken ya kk (^_^)",    
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":{},
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Boss ⏩Azdar Team Bot⏪ (^_^)")
...
#		else:                    
		...
		if wait["Simi"] == True: md+="╠➩✔️ Simisimi : On\n"
            ...
            elif msg.text.lower() in ["hah","addeh","kaget"]:
                msg.contentType = 7
		...
		if msg.from_ in Creator:
            ...
            elif msg.text in ["Azdar","Join All"]:
		if msg.from_ in admin:
		...
		cl.sendText(msg.to,"⏩ Azdar Team Bot ⏪")
                ...
                kr.sendText(msg.to,"Ada yg bisa dibanting  👀")
		...
		if msg.from_ in Creator:
            ...
            elif msg.text.lower() in ["echi","azdar"]:
